...
class Config(object):
    ...
    def __init__(self):
        ...
        # 模型及路径配置
        self.initial_pretrain_model = "E:/transformers/models--albert-base-v2/snapshots/eab127d1a4a42b10e2b130e1834c64f5844d541e"           # 加载的预训练分词器checkpoint，默认为英文。若要选择中文，替换成 bert-base-chinese
        self.initial_pretrain_tokenizer = "E:/transformers/models--albert-base-v2/snapshots/eab127d1a4a42b10e2b130e1834c64f5844d541e"       # 加载的预训练模型checkpoint，默认为英文。若要选择中文，替换成 bert-base-chinese
        self.path_model_save = './albert/test/'                      # 模型保存路径
        self.path_datasets = './datasets/'                          # 数据集
        self.path_log = './logs/'
        self.path_model_predict = os.path.join(self.path_model_save, 'epoch_9')
#4acc= 0.16147849010039822